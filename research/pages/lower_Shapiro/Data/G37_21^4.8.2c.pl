...
my $prblmname = "G37_21^4.2c";
my $number_solutions = 8;
my $number_files = 60;
...
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  #printf SING  "ring R = 32003, (a,b,c,d,e,f,g,h,x,y,z,w), dp;\n";
  printf SING  "ring R = 0, (a,b,c,d,e,f,g,h,x,y,z,w), dp;\n";
  printf SING  "ideal I;\n";
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(0,2,'G37_21')){
      printf SING " $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
