...
my $prblmname = "G26_1^8.3c";
my $number_solutions = 14;
my $number_files = 20;
my $number_per_file = 500;

my $size = 1000;
#
#  16.650 for 1000 and size =   30 
#   2.730 for  100 and size =   50
#   2.880 for  100 and size =  100
#   4.500 for  100 and size = 1000
#
...
for (my $outer=1; $outer<=$number_files; $outer++)
{
  #  Initialize @freq
  my @freq=();
  for (my $i=0;  $i<= ceil($number_solutions/2); $i++){push(@freq,0)}
  ###########################################################################
  #
  #  Singular header
  #
  ...
  #printf SING  "ring R = 32003, (a,b,c,d,e,f,g,h), dp;\n";
  printf SING  "ring R = 0, (a,b,c,d,e,f,g,h), dp;\n";
  printf SING  "ideal I;\n";
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(2,3,'G26_1')){
      printf SING " $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
  ...
  #
  for (my $i=0; $i<=ceil($number_solutions/2); $i++){
