...
% When answering this assignment, you will want to edit these instructions, perhaps removing some (like the first two)
...
\item     Write a paragraph or two on your favorite video.
  ...
  \item   List some of the videos that you watched.
    ...
    %  (use \newline to start a new line, or (better) use a blank line between each video name
