...
my $prblmname = "G26_2_1^6.2c";
my $number_solutions = 9;
my $number_files = 50;
my $number_per_file = 20;

my $size = 500;
#
#   to compute 100 instances with size number 1000 
#
...
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  #printf SING  "ring R = 32003, (a,b,c,d,g,h), dp;\n";
  printf SING  "ring R = 0, (a,b,c,d,g,h), dp;\n";
  printf SING  "ideal I;\n";
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(2,2,'G26_1_2inf')){
      printf SING " $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
