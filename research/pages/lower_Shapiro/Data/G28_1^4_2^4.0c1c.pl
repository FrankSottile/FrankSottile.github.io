...
my $prblmname = "G28_1^4_2^4.0c1c";
my $number_solutions = 30;
my $number_files = 50;
my $number_per_file = 1000;
 $number_files = 1;
my $size = 250;
#
...
#
my $date=time;
my $number = int(($date-1286306000)*($date-128610420)/$$)+$$;
#$number = 17206761;
print $date, " Seed for PID ", $$, " is ", $number, "  size of numbers is ",$size,"\n";
...
#printf  OUTPUTFILE "\n0\n";
#
#0 0 11276 4612 2041 2468 1033 584 724 1048 853 909 1031 333 290 3798
#116515
#G28_1^4_2^4.0c1c   Seed for PID 3038 is 121572850089  size of numbers is 250
#0 0 17829 7434 3206 3859 1603 936 1095 1700 1339 1384 1606 543 461 6005
#180146

printf  OUTPUTFILE "0 0 17829 7434 3206 3859 1603 936 1095 1700 1339 1384 1606 543 461 6005\n180146\n";
close(OUTPUTFILE);
#
#  The outer loop
#
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  #printf SING  "ring R = 32003, (a,b,c,d,e,f,g,h,i,j), dp;\n";
  printf SING  "ring R = 0, (a,b,c,d,e,f,g,h,i,j), dp;\n";
  printf SING  "ideal I;\n";
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(4,0,'G28_1_2inf')){
      printf SING " $pols+";
    }
    foreach $pols (get_equations(1,1,'G28_2_2inf')){
      printf SING "  $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
