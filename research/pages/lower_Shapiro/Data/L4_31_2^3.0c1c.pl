...
my $prblmname = "L4_31_2^3.0c1c";
my $number_solutions = 10;
my $number_files = 40;
...
#0 6636 2864 0 0 0 
#6383
#Seed for PID 4807 is 248826217  size of numbers is 150
printf  OUTPUTFILE "0 6636 2864 0 0 0 \n6383\n";
...
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(1,1,'L4_2_31inf')){
      printf SING " $pols+"; 
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
