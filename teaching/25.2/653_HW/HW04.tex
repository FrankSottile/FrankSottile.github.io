...
\item   
   Let $G_1$ and $G_2$ be groups and suppose that  $H$ is a subgroup of $G_1\times G_2$ whose image under each
    ...
    Let $N_1\subset H$ be the kernel of the projection $p_2$ restricted to $H$ and let $N_2\subset H$ be the kernel of the
    projection $p_1$ restricted to $H$.
    Show that we may identify $N_i$ as a normal subgroup of $G_i$, for  $i\in\{1,2\}$.
