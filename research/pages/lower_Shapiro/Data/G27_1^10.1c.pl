...
my $size = 500;
#
#  3.83 to compute 10 files with number size 300
#  5.34  to compute 10 files with number size 500
#
#
...
#  printf SING  "ring R = 32003, (a,b,c,d,e,g,h,i,j), dp;\n";
  printf SING  "ring R = 0, (a,b,c,d,e,g,h,i,j), dp;\n";
  printf SING  "ideal I;\n";
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(7,1,'G27_1_inf')){
      printf SING " $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
