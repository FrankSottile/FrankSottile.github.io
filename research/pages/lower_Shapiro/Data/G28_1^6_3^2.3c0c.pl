...
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  #printf SING  "ring R = 32003, (a,b,c,d,e,f,g,h,i), dp;\n";
  printf SING  "ring R = 0, (a,b,c,d,e,f,g,h,i), dp;\n";
  printf SING  "ideal I;\n";
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(0,3,'G28_1_3inf')){
      printf SING " $pols+";
    }
    foreach $pols (get_equations(1,0,'G28_3_3inf')){
      printf SING "  $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
