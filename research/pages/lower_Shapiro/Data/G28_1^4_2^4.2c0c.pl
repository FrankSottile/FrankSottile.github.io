...
my $prblmname = "G28_1^4_2^4.2c0c";
my $number_solutions = 30;
my $number_files = 50-22;
...
#}
#printf  OUTPUTFILE "\n0\n";
printf  OUTPUTFILE "0 0 0 9491 3229 1196 4853 1170 631 451 76 121 75 74 62 571\n64047\n";
close(OUTPUTFILE);
#
#  The outer loop
#
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(0,2,'G28_1_2inf')){
      printf SING " $pols+";
    }
