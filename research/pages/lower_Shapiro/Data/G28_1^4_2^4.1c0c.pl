...
#printf  OUTPUTFILE "\n0\n";
#
#0 0 0 0 0 0 28090 5395 3233 1826 954 853 418 482 378 7371
#138794
#
#
printf  OUTPUTFILE "0 0 0 0 0 0 28090 5395 3233 1826 954 853 418 482 378 7371\n138794\n";
close(OUTPUTFILE);
#
#  The outer loop
#
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(2,1,'G28_1_2inf')){
      printf SING " $pols+";
    }
    foreach $pols (get_equations(3,0,'G28_2_2inf')){
      printf SING "  $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
