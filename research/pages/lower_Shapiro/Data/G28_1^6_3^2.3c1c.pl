...
my $prblmname = "G28_1^6_3^2.3c1c";
my $number_solutions = 20;
my $number_files = 500;
my $number_per_file = 800;

$number_files = 300-263;
...
#
my $date=time;                             
my $number = int(($date-1286370000)*($date-128630420)/$$)+$$;
#$number = 17206761;
...
#}
#printf  OUTPUTFILE "\n0\n";
#0 0 0 0 171797 26408 8952 1483 714 412 634
#128006
printf  OUTPUTFILE "0 0 0 0 171797 26408 8952 1483 714 412 634\n128006\n";
close(OUTPUTFILE);
#
#  The outer loop
#
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  #printf SING  "ring R = 32003, (a,b,c,d,e,f,g,h,i,j,m,n), dp;\n";
  printf SING  "ring R = 0, (a,b,c,d,e,f,g,h,i,j,m,n), dp;\n";
  printf SING  "ideal I;\n";
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(0,3,'G28_1')){
      printf SING " $pols+";
    }
    foreach $pols (get_equations(0,1,'G28_3')){
      printf SING "  $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
