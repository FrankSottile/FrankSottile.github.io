...
my $prblmname = "G36_1^9.1c";
my $number_solutions = 42;
my $number_files = 40;
my $number_per_file = 200;

my $size = 1000;
#
#  18 to compute 10 instances with number size 100
#  schubert took 4.9 to compute 10 instances with number size 100
#  18.97 to compute 20 instances with size number 1000 
#
...
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  #printf SING  "ring R = 32003, (a,b,c,d,e,f,h,i), dp;\n";
  printf SING  "ring R = 0, (a,b,c,d,e,f,h,i), dp;\n";
  printf SING  "ideal I;\n";
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(6,1,'G36_1_inf')){
      printf SING " $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
