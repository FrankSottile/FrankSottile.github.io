...
my $prblmname = "G27_2_1^8.1c";
my $number_solutions = 28;
my $number_files = 20;
my $number_per_file = 200;

my $size = 500;
#
#  .92 to compute 10 files with number size 500
#
#
...
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(6,1,'G27_1_2inf')){
      printf SING " $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
