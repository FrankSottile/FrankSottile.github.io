...
my $prblmname = "G37_2^6.3c";
my $number_solutions = 16;
my $number_files = 100;
my $number_per_file = 100;
$number_files = 1;       # There was one instance that was not computed 
$number_per_file = 1;    #  due to internal filters for Shape Lemma
my $size = 30;
#
...
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  #printf SING  "ring R = 32003, (a,b,c,d,e,f,g,h,i,j,n,m), dp;\n";
  printf SING  "ring R = 0, (a,b,c,d,e,f,g,h,i,j,n,m), dp;\n";
  printf SING  "ideal I;\n";
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(0,3,'G37_2')){
      printf SING " $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
