...
#
#   First 50,000 instances
#
#14382 2003 16371 5669 11183 377 15 0 0
#67572
#
#  Some more
#
#15364 2127 17503 6071 12014 403 18 0 0
#72303
...
#}
#printf  OUTPUTFILE "\n0\n";
printf  OUTPUTFILE "15364 2127 17503 6071 12014 403 18 0 0\n72303\n";
close(OUTPUTFILE);
#
#  The outer loop
#
for (my $outer=1; $outer<=$number_files; $outer++)
{
  ...
  for (my $i=1; $i<=$number_per_file; $i++){
    printf SING "I = \n";
    foreach $pols (get_equations(2,2,'L3_1')){
      printf SING " $pols+";
    }
    printf SING "0;\n";
    printf SING "I = std(I);\n";
